...
<head>
  ...
  <link rel="stylesheet" href="/css/styles.css?v=site-20260718-18">
  <style>
...
<body class="store-body store-admin-page" data-store-page="admin" data-admin-authenticated="false">
              ...
              <form class="store-admin__form" id="adminProductForm">
                ...
                <div class="store-admin__fields">
                  ...
                  <label>
                    ...
                    <input name="price" type="text" inputmode="numeric" placeholder="$ 1.450.000" data-currency-cop required>
                  </label>
                  <label>
                    <span>Precio anterior</span>
                    <input name="oldPrice" type="text" inputmode="numeric" placeholder="$ 1.690.000" data-currency-cop>
                  </label>
                  <label>
                    <span>Stock</span>
  ...
  <script src="/js/store.js?v=tracking-admin-20260718-15"></script>
  <script>
    (() => {
